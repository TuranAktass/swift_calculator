...
#ifndef CALCULATOR_SWIFT_SWIFT_H
#define CALCULATOR_SWIFT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="calculator_swift",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16calculator_swift11AppDelegate")
...
SWIFT_CLASS("_TtC16calculator_swift13SceneDelegate")
...
SWIFT_CLASS("_TtC16calculator_swift14ViewController")
@interface ViewController : UIViewController
- (void)viewDidLoad;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified number1Field;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified number2Field;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified result;
- (IBAction)multiply:(id _Nonnull)sender;
- (IBAction)divide:(id _Nonnull)sender;
- (IBAction)diiference:(id _Nonnull)sender;
- (IBAction)sum:(id _Nonnull)sender;
